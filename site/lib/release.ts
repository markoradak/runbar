 ...
 *
 * Revalidates hourly. Unauthenticated GitHub API calls are limited to 60/hr per
 * IP; caching keeps us far under it, and any failure degrades to a plain link to
